...
<div id="container">
  ...
  <div id="body">
    ...
    <p>&nbsp;</p>
    <p class="subHead"><strong> Clients</strong>    </p>
    <?php if (isset($_GET['staff'])) { ?><p class="subHead">(Added by $staff)</p><?php } ?>
    <p>&nbsp;</p>
    <?php if ($totalRows_clients == 0) { // Show if recordset empty ?>
    <div class="msgBoxRed">Clients List is empty!</div>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="5">
      ...
      <?php do { ?>
        <tr>
          ...
          <td><a href="a-edit-client.php?id=<?php echo $row_clients['id']; ?>" title="Edit Client" ><img src="images/glyphicons_030_pencil.png" alt="" width="16" border="0" /></a>&nbsp;
          <a href="a-delete-client.php?id=<?php echo $row_clients['id']; ?>" title="Delete Client" class="ValidateAction" data-confirm-msg="Are you sure you want to delete this Client?"><img src="images/glyphicons_016_bin.png" alt="Delete" width="16" border="0" /></a></td>
        </tr>
