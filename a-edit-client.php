...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "formAddClient")) {
  $updateSQL = sprintf("UPDATE clients SET title=%s, firstname=%s, surname=%s, designation=%s, `level`=%s, influenceRating=%s, areaOfInterface=%s, email=%s, organisation=%s, buildingNum=%s, street=%s, area=%s, city=%s, `state`=%s WHERE id=%s",
  ...
  $updateGoTo = "a-clients.php?msg=Client Updated!";
  if (isset($_SERVER['QUERY_STRING'])) {
...
<div id="container">
  ...
  <div id="navbar">
    <div class="left"><a href="a-clients.php"><strong>Clients</strong></a></div>
    <div class="right">Logged in as<strong> admin</strong>| <a href="a-logout.php"><strong>Logout</strong></a>
    </div>
    <div class="clear"></div>
  </div>
  <div id="body">
              ...
              <td><table width="100%" border="0" cellspacing="0" cellpadding="5">
                <tr>
                  ...
                  <td width="44%" valign="top"><select type="text" id="title" name="title">
                    ...
                    <option value="Rev" <?php if (!(strcmp("Rev", $row_client['title']))) {echo "selected=\"selected\"";} ?>>Rev</option>
                ...
                <tr>
                  ...
                  <td valign="top"><span id="sprytextfield5">
                    ...
                    <input name="organisation" type="text" class="w308" id="organisation" value="<?php echo $row_client['organisation']; ?>" />
                  <span class="textfieldRequiredMsg">A value is required.</span></span></td>
                  <td valign="top">&nbsp;</td>
                </tr>
                <tr>
                ...
                <tr>
                  <td valign="top"><a href="a-clients.php">
